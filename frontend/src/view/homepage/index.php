...
<body class="font-poppins">
    ...
    <div class=" w-full bg-[#ffffff] h-auto py-12">
        <div class="lg:mx-16 mx-2">
            <h1 class="font-bold text-3xl py-14 pl-4">Novel Terpopuler🔥</h1>
            <div class="grid lg:grid-cols-4 grid-cols-2 lg:gap-0 gap-6">
                <a href="../../view/novel-detail/index.php" class="card border-2 shadow  mx-auto p-4 cursor-pointer transition duration-500 ease-in-out hover:bg-primary">
                    <img class="" src="../../assets/images/exam.png" alt="errr" width=220>
                    <button class="text-white bg-secondary py-2 px-6 my-4 rounded">Fantasy</button>
                    <p class="font-bold">The Prince Of Bayu Wijaya</p>
                    <p class="text-gray-500">Martimbul Siregar</p>
                    <div class="rating lg:flex hidden justify-between mx-2 items-center pt-6">
                        <div class="flex">
                            <svg class="w-6 fill-yellow-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
